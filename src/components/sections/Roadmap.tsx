                    ...
                    <div className="lg:hidden relative space-y-8 pl-4">
                        ...
                        {roadmapSteps.map((s, index) => (
                            <div key={s.id} className="mobile-card relative pl-8">
                                {/* Dot on timeline */}
                                <div className={`absolute left-0 top-6 -translate-x-1/2 size-8 rounded-full border-4 border-[#F9FAFB] flex items-center justify-center z-10 transition-all duration-500 ${index <= currentStep ? "bg-[#2a6ba7] text-white shadow-[0_0_15px_rgba(42,107,167,0.4)]" : "bg-white text-gray-400 border-gray-200"
                                    }`}>

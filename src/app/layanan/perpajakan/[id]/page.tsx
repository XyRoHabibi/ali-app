                            ...
                            <div>
                                ...
                                <div className="grid sm:grid-cols-2 gap-6">
                                    <div className="p-6 bg-white rounded-2xl border border-gray-100 shadow-sm">
                                        ...
                                        <h3 className="font-bold text-lg mb-2">Layanan Terpercaya</h3>
                                        <p className="text-sm text-gray-500">Ditangani oleh praktisi perpajakan profesional yang berpengalaman di bidangnya.</p>
                                    </div>
                                    <div className="p-6 bg-white rounded-2xl border border-gray-100 shadow-sm">
                                        <div className="size-10 rounded-lg bg-blue-100 text-blue-600 flex items-center justify-center mb-4">
                                            <span className="material-symbols-outlined">speed</span>
                                        </div>
                                        <h3 className="font-bold text-lg mb-2">Proses Akurat</h3>
                                        <p className="text-sm text-gray-500">Pengerjaan teliti untuk memastikan kepatuhan pajak Anda terpenuhi dengan benar.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <ul className="space-y-4">
                                    {[
                                        "KTP Pemohon (WNI)",
                                        "NPWP Pribadi (Aktif)",
                                        "Data / Berkas Pendukung Sesuai Layanan",
                                        "Akses Akun Terkait (Jika diperlukan)"
                                    ].map((item, i) => (
                        ...
                        <div className="relative flex flex-col md:flex-row items-center gap-12 p-8 md:p-16 rounded-[3rem] border-2 border-primary bg-white shadow-2xl overflow-hidden group">
                            ...
                            <div className="flex-1 space-y-8">
                                <div>
                                    ...
                                    <p className="text-gray-500 font-bold text-sm uppercase tracking-widest">Paket Layanan</p>
                                </div>
                                <ul className="space-y-4">
                                    {[
                                        "Layanan Profesional & Akurat",
                                        "Kepatuhan Pajak Terjamin",
                                        "Konsultasi Gratis dengan Praktisi",
